...
function showEk2Modal(employeeIndex) {
    ...
    ek2Content.innerHTML = `
        <div class="alert alert-info">
            <h4>EK-2 Formu - ${employee.name}</h4>
            <p>EK-2 formu Google Docs üzerinde açılacaktır. Lütfen bekleyin...</p>
            <button id="openGoogleDocBtn" class="btn btn-primary">
                <i class="fas fa-external-link-alt"></i> Google Docs'ta Aç
            </button>
            <div class="mt-3">
                <small class="text-muted">Not: Düzenledikten sonra dosyayı indirip sisteme yükleyebilirsiniz.</small>
            </div>
        </div>
    `;
    
    document.getElementById('openGoogleDocBtn').addEventListener('click', () => {
        const docUrl = `https://docs.google.com/document/d/1i_4ZaDcmsPYuLDzGwAdxuD5CYgfGaRHG/edit?usp=sharing`;
